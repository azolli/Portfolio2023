<script lang="ts">
    ...
    import EducationCard from './education_card.svelte';
    ...
    let icons: Array<string> = ["c.png", "rust.png", "node.png", "django.png", "react.png", "python.png", "tensorflow.png", "opencv.webp"];
...
<section on:copy={elementCopied}>
    ...
    <section>
        ...
        <div class="flex justify-center flex-wrap">
            <EducationCard school="Politecnico di Torino" degreeType="Engineering Bachelor Degree" year="0" />
            <EducationCard school="Liceo Salesiano Valsalice" degreeType="Maturità Scientifica (Sc. App.) - 92/100" year="2022" />
        </div>
    </section>
    <section class="mt-24">
        <h2 use:viewport on:enterViewport={() => shuffleIcons()} class="text-4xl font-bold text-center my-8">Most used technologies</h2>
    ...
    <section class="mt-12">
        ...
        <div class="flex justify-center flex-wrap">
            <ProjectCard customer="Digisky S.r.l." role="Embedded Software Developer" img="https://picsum.photos/1920" />
            <ProjectCard customer="ToVision By Xiaomi 2022" role="Full Stack Developer" img="https://picsum.photos/1920" />
